...
function DropdownMenuTrigger({
  ...
  if (render) {
    const renderChildren = (render.props as { children?: React.ReactNode })?.children
    return (
      <DropdownMenuPrimitive.Trigger asChild {...props}>
        {React.cloneElement(render, {}, children ?? renderChildren)}
      </DropdownMenuPrimitive.Trigger>
    )
  }
  return (
    <DropdownMenuPrimitive.Trigger asChild={asChild} data-slot="dropdown-menu-trigger" {...props}>
      {children}
    </DropdownMenuPrimitive.Trigger>
  )
}
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.SubContent
        ...
        className={cn(
          "z-10005 min-w-40 origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden bg-popover/95 p-1 text-xs text-popover-foreground shadow-lg backdrop-blur-md ring-1 ring-foreground/10 outline-hidden duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-10005 max-h-(--radix-dropdown-menu-content-available-height) min-w-48 origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto bg-popover/95 p-1 text-xs text-popover-foreground shadow-lg backdrop-blur-md ring-1 ring-foreground/10 outline-hidden duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      />
